...
###################################################
### chunk number 18: west-data-attach
###################################################
...
###################################################
### chunk number 19: west-glmboost-ytrans
###################################################
...
###################################################
### chunk number 20: west-glmboost-family
###################################################
...
###################################################
### chunk number 21: west-glmboost-fit eval=FALSE
###################################################
## ### fit a linear model with initial mstop = 200 boosting iterations
## ctrl <- boost_control(mstop = 200, center = TRUE)
## west_glm <- glmboost(x, yfit, family = L2fm, 
##                      control = ctrl)


###################################################
### chunk number 22: west-glmboost-fit-lars
###################################################
### fit a linear model with initial mstop = 200 boosting iterations
### and record time
time <- system.time(west_glm <- glmboost(x, yfit, family = L2fm, 
                    control = boost_control(mstop = 200, center = TRUE)))[1]
x <- t(exprs(westbc) - rowMeans(exprs(westbc)))


###################################################
### chunk number 23: west-glmboost-AIC
###################################################
...
###################################################
### chunk number 24: west-glmboost-cf
###################################################
cf <- coef(west_glm[mstop(aic)])
ps <- length(cf[abs(cf) > 0])


###################################################
### chunk number 25: west-glmboost-plot
###################################################
...
###################################################
### chunk number 29: wpbc-glmboost-fit
###################################################
...
###################################################
### chunk number 30: wpbc-glmboost-AIC
###################################################
...
###################################################
### chunk number 31: wpbc-glmboost-fit2
###################################################
### fit with new mstop
...
###################################################
### chunk number 32: wpbc-gamboost-fit
###################################################
...
###################################################
### chunk number 33: wpbc-gamboost-plot
###################################################
...
###################################################
### chunk number 34: pkg-attach
###################################################
source("setup.R")


###################################################
### chunk number 35: wpbc-glmboost-PIC
###################################################
...
###################################################
### chunk number 36: wpbc-glmboost-censored-fit
###################################################
ctrl <- boost_control(mstop = 500, center = TRUE)
...
###################################################
### chunk number 37: wpbc-glmboost-coef
###################################################
names(coef(wpbc_surv)[abs(coef(wpbc_surv)) > 0])


###################################################
### chunk number 38: wpbc-glmboost-censored-fit
###################################################
